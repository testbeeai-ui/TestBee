...
- **Interactive Sandboxes:**
  - _Particle Collision Simulator:_ Visualizes gas molecules and collision forces.
  - _Wall Toggle Simulation:_ Interactive thermodynamics (diathermic vs. adiabatic walls).
  - _Thermometer Scale Sandbox:_ Real-time temperature conversion visualizer.
