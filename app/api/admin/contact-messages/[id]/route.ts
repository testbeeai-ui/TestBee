...
import type { ContactAdminStatus } from "@/lib/contact/contactMessageTypes";

function isAdminStatus(v: unknown): v is ContactAdminStatus {
  return v === "new" || v === "reviewed" || v === "resolved";
}

/** PATCH /api/admin/contact-messages/[id] — triage status / internal note. */
export async function PATCH(request: Request, context: { params: Promise<{ id: string }> }) {
  try {
    ...
    console.error("[admin/contact-messages] PATCH", e);
