...
export default function Profile() {
  ...
  const classLevelDisplay =
    profile?.class_level != null ? `Class ${profile.class_level}` : "Classes 11 & 12";
  ...
  const { totalAnswered, totalCorrect, totalWrong, totalSkipped, accuracy } = useMemo(() => {
            ...
            <div className="space-y-4 2xl:space-y-5">
              ...
              <div className="grid grid-cols-2 gap-2 md:grid-cols-4 2xl:gap-3">
                {[
                  ...
                  >
                    <stat.icon
                      className={`mx-auto mb-1 h-3.5 w-3.5 ${stat.iconColor} 2xl:mb-2 2xl:h-4 2xl:w-4`}
                    />
                    <p className="text-2xl font-black leading-none text-foreground dark:text-white 2xl:text-3xl">
                      {stat.value}
                    </p>
                    <p className="mt-0.5 text-xs font-semibold text-muted-foreground dark:text-slate-400 2xl:mt-1 2xl:text-sm">
                      {stat.label}
                    </p>
                  </div>
                ))}
          ...
          <div className="mt-4 space-y-3 2xl:mt-6 2xl:space-y-4">
            ...
            >
              <div className="mb-2 flex items-center justify-between 2xl:mb-3">
                <h3 className="flex items-center gap-1.5 text-lg font-black text-foreground dark:text-white 2xl:gap-2 2xl:text-xl">
                  <Activity className="h-4 w-4 shrink-0 text-emerald-400 2xl:h-5 2xl:w-5" />{" "}
                  Performance
                </h3>
              ...
              <div className="mt-3 flex flex-wrap items-center justify-between gap-2 text-sm">
                ...
                <span className="font-extrabold text-foreground dark:text-slate-200">
                  {accuracy}% Accuracy
                </span>
              </div>
              <div className="mt-3 grid grid-cols-1 gap-2 md:grid-cols-3 2xl:mt-4 2xl:gap-3">
                <div className="rounded-lg border border-emerald-400/20 bg-muted/40 p-2.5 dark:bg-slate-900/70 2xl:rounded-xl 2xl:p-3">
                  <p className="text-[10px] uppercase tracking-wide text-muted-foreground dark:text-slate-400 2xl:text-xs">
                    Correct
                  </p>
                  <p className="text-2xl font-black text-emerald-400 2xl:text-3xl">
                    {totalCorrect}
                  </p>
                </div>
                ...
                <div className="rounded-lg border border-border bg-muted/40 p-2.5 dark:border-slate-700 dark:bg-slate-900/70 2xl:rounded-xl 2xl:p-3">
                  ...
                  <p className="text-2xl font-black text-foreground dark:text-white 2xl:text-3xl">
                    {totalSkipped}
                  </p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 gap-3 lg:grid-cols-2 2xl:gap-4">
              <div className="rounded-2xl border border-border bg-card p-4 dark:border-white/10 dark:bg-slate-950/80 2xl:p-5">
                <h3 className="mb-0.5 text-lg font-black text-foreground dark:text-white 2xl:mb-1 2xl:text-xl">
                  Settings
                </h3>
                <p className="mb-3 text-xs text-muted-foreground dark:text-slate-400 2xl:mb-4 2xl:text-sm">
              ...
              <div className="space-y-3 2xl:space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-400/25 bg-gradient-to-br from-cyan-500/10 via-transparent to-violet-500/10 p-4 dark:border-cyan-300/20 dark:bg-[radial-gradient(circle_at_top_right,rgba(45,212,191,0.16),transparent_55%),radial-gradient(circle_at_bottom_left,rgba(139,92,246,0.14),transparent_55%),rgba(2,6,23,0.86)] 2xl:p-5">
                  <div className="mb-0.5 flex items-center justify-between 2xl:mb-1">
                    <h3 className="flex items-center gap-1.5 text-lg font-black text-foreground dark:text-white 2xl:gap-2 2xl:text-xl">
                      <MessageSquare className="h-4 w-4 shrink-0 text-cyan-300 2xl:h-5 2xl:w-5" />{" "}
                      Contact Us
                    </h3>
                  ...
                  <p className="text-sm text-muted-foreground dark:text-slate-300/90">
                    Report an issue, ask for partnerships, or share suggestions. We usually reply
                    within 24–48 hours.
                  </p>
                  <Button
                    variant="link"
