...
import { BLOG_SECTIONS, EXAMS, getPublicNewsSections, isAdminOnlyNewsSection } from "./constants";
...
import { NewsBlogOnboardingTracker } from "./components/NewsBlogOnboardingTracker";
                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    <label className="text-xs">
                      ...
                      >
                        ...
                        {(draft.portal === "news" ? composerNewsSections : BLOG_SECTIONS).map(
                          (s) => (
                    ...
                    {draft.portal === "news" ? (
                      draft.section === "ndates" ? (
                        <>
                          ...
                          <label className="text-xs sm:col-span-2">
                            <span className="mb-1 block text-slate-400">Link (official page)</span>
                            <input
                              type="url"
                        ...
                        <label className="text-xs sm:col-span-2">
                          <span className="mb-1 block text-slate-400">Source link (required)</span>
                          <input
                            type="url"
                            value={draft.sourceLink}
                            onChange={(e) =>
                        ...
                        <p className="mt-1 text-xs text-slate-500">
                          {composerHtmlLayoutTab ? (
                            <>
                              ...
                              summary from the page; edit those on <strong>Write text</strong> with
                              author, references, keywords, and publish date.
                            </>
                          ) : (
                            <>
                              One post, two categories: headline and summary live on{" "}
                              <strong>Write text</strong> with the article body (also SEO and{" "}
                              &quot;View text&quot; when HTML exists). <strong>Upload HTML</strong>{" "}
                              is markup only. Preview follows the tab you are on.
                            </>
                          )}
                        </p>
                      </div>
                    ...
                    {isKeyDatesDraft ? (
                      <>
                        ...
                        <p className="text-[11px] leading-5 text-slate-500">
                          ...
                          lists; body is optional full detail on the post page. Exam category comes
                          from the dropdown - it appears under each row in the feed.
                        </p>
                      </>
                    ) : (
                      <>
                            ...
                            <span className="mb-1 block text-slate-400">
                              ...
                              {draft.rawHtml.trim() ? (
                                <span className="ml-1.5 font-normal text-slate-500">
                                  (plain article; also SEO / &quot;View text&quot; when HTML is set)
                                </span>
                              ) : null}
                            </span>
                            <textarea
                  ...
                  {isKeyDatesDraft ? (
                    ...
                    <div className="mt-2 overflow-hidden rounded-lg border border-emerald-500/25 bg-[#0f1826]">
                      {previewHtmlPlain ? (
                        ...
                        <HtmlBodyFrame html={draft.rawHtml} title={draft.title || "HTML preview"} />
                      )}
                    </div>
                  ) : (
