    ...
    case "h2":
      return (
        <h2
          key={key}
          id={b.id}
          className="mt-6 scroll-mt-24 text-xl font-semibold tracking-tight text-slate-100 sm:mt-10 sm:text-2xl"
        >
          {b.text}
        </h2>
      );
    case "h3":
      return (
        <h3
          key={key}
          id={b.id}
          className="mt-4 scroll-mt-24 text-lg font-semibold tracking-tight text-slate-100 sm:mt-8 sm:text-xl"
        >
          {b.text}
        </h3>
      );
      ...
      <header className="mb-8 border-b border-slate-700/40 pb-6">
        {summary ? (
          ...
          <p className="mb-5 text-sm leading-relaxed text-slate-500">
            No summary on text view yet {"\u2014"} add one when editing; the HTML layout keeps its
            own headline and intro.
          </p>
        )}
