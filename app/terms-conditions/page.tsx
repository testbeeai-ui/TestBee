    ...
    <>
      <div className="mb-6 border-b border-white/10 pb-4">
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          <Badge color="teal" icon="ti ti-shield-check">
            DPDP Act 2023 compliant
          </Badge>
          <Badge color="blue" icon="ti ti-file-text">
            IT Act 2000
          </Badge>
          <Badge color="purple" icon="ti ti-device-laptop">
            EdTech guidelines
          </Badge>
      ...
      <HighlightBox color="teal" title="About these documents">
        <p className="text-sm leading-relaxed text-white/50">
          EduBlast is an educational social media and EdTech platform operated by EduBlast
          Technologies Private Limited, a company registered under the Companies Act, 2013, with its
          registered office in Bengaluru, Karnataka, India. These documents govern your use of the
          EduBlast platform including its website, mobile application, and all associated services.
        </p>
        <p className="mt-2 text-sm leading-relaxed text-white/50">
          By registering an account or using the platform, you confirm that you have read,
          understood, and agree to be bound by these terms. If you are a minor under 18 years, your
          parent or legal guardian must read and consent on your behalf.
        </p>
      </HighlightBox>
      ...
      <div className="mb-5 grid grid-cols-1 gap-3 sm:grid-cols-2">
        <Link
          ...
          className="rounded-lg border border-white/10 bg-[#1C2333] p-4 transition-colors hover:border-[#1D9E75]/30"
        >
        ...
        >
          ...
          <p className="text-xs leading-relaxed text-white/50">
            Explains what personal data we collect, why we collect it, how long we keep it, who we
            share it with, your rights under the DPDP Act 2023, and how to contact our grievance
            officer.
          </p>
          <div className="mt-2.5 text-[11px] text-[#1D9E75]">
            12 sections &middot; click to open <i className="ti ti-arrow-right text-xs" />
      ...
      <div className="grid grid-cols-1 gap-2.5 sm:grid-cols-2">
        <RightCard
          ...
          title="DPDP Act 2023"
          text="Fully aligned with India's Digital Personal Data Protection Act 2023 — including consent notices, data principal rights, data fiduciary obligations, and child data protections."
        />
        <RightCard
          icon="ti ti-device-laptop"
          title="IT Act 2000 & IT Rules"
          text="Compliant with the Information Technology Act 2000, IT (Intermediary Guidelines) Rules 2021, and the Reasonable Security Practices Rules."
        />
        <RightCard
          icon="ti ti-school"
          title="EdTech guidelines"
          text="Follows MEITY and MoE advisory guidelines for online education platforms including data minimisation, purpose limitation, and minor user protections."
        />
        <RightCard
          icon="ti ti-users"
          title="Social media norms"
          text="Complies with Significant Social Media Intermediary (SSMI) obligations under IT Rules 2021 as applicable to UGC platforms above threshold user counts."
        />
      </div>
    </>
  );
