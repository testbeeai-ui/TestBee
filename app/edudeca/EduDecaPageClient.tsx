  ...
  return (
    ...
    >
      ...
      <div
        className={
          submitted
            ? "relative mx-auto flex min-h-[calc(100dvh-3.5rem)] w-full max-w-3xl flex-col items-center justify-center px-4"
            : "relative mx-auto w-full max-w-3xl px-4 pb-16 pt-6 sm:px-6 sm:pb-20 sm:pt-8"
        }
      >
        {submitted ? null : (
