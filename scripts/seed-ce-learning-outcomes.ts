/**
 * Seed Learning Outcomes for Current Electricity into
 * `learning_outcomes_questions` from tmp-ce-outcomes-parsed.json.
 *
 * Source DOCX: Class 12 Physics Current Electricity Learning Outcomes.docx
 *
 * Env: NEXT_PUBLIC_SUPABASE_URL, SUPABASE_SERVICE_ROLE_KEY
 * Run: npx tsx --env-file=.env scripts/seed-ce-learning-outcomes.ts
 */
...
const SOURCE = "Class 12 Physics Current Electricity Learning Outcomes.docx";
...
async function main() {
  ...
  const parsedPath = resolve(process.cwd(), "tmp-ce-outcomes-parsed.json");
