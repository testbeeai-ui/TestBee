/**
 * Seed Learning Outcomes for Alternating Current into
 * `learning_outcomes_questions` from tmp-ac-outcomes-parsed.json.
 *
 * Source DOCX: Learning Outcomes Alternative Current Class 12 Physics.docx
 *
 * Env: NEXT_PUBLIC_SUPABASE_URL, SUPABASE_SERVICE_ROLE_KEY
 * Run: npx tsx --env-file=.env scripts/seed-ac-learning-outcomes.ts
 */
...
const SOURCE = "Learning Outcomes Alternative Current Class 12 Physics.docx";
...
async function main() {
  ...
  const parsedPath = resolve(process.cwd(), "tmp-ac-outcomes-parsed.json");
