/**
 * Seed Learning Outcomes for Matrices into
 * `learning_outcomes_questions` from tmp-matrices-outcomes-parsed.json.
 *
 * Source DOCX: Learning Outcomes Class 12 Maths Matrices.docx
 *
 * Env: NEXT_PUBLIC_SUPABASE_URL, SUPABASE_SERVICE_ROLE_KEY
 * Run: npx tsx --env-file=.env scripts/seed-matrices-learning-outcomes.ts
 */
...
const SOURCE = "Learning Outcomes Class 12 Maths Matrices.docx";
...
async function main() {
  ...
  const parsedPath = resolve(process.cwd(), "tmp-matrices-outcomes-parsed.json");
