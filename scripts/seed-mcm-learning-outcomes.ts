/**
 * Seed Learning Outcomes for Moving Charges and Magnetism into
 * `learning_outcomes_questions` from tmp-mcm-outcomes-parsed.json.
 *
 * Source DOCX: Learning Outcomes Moving Charges and Magnetism.docx
 *
 * Env: NEXT_PUBLIC_SUPABASE_URL, SUPABASE_SERVICE_ROLE_KEY
 * Run: npx tsx --env-file=.env scripts/seed-mcm-learning-outcomes.ts
 */
...
const SOURCE = "Learning Outcomes Moving Charges and Magnetism.docx";
...
async function main() {
  ...
  const parsedPath = resolve(process.cwd(), "tmp-mcm-outcomes-parsed.json");
