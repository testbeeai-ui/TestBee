/**
 * Seed Learning Outcomes for Electrostatic Potential and Capacitance
 * into `learning_outcomes_questions` from tmp-epc-outcomes-parsed.json.
 *
 * Source DOCX: Electrostatic Potential and Capacitance  Learning Outcomes.docx
 *
 * Env: NEXT_PUBLIC_SUPABASE_URL, SUPABASE_SERVICE_ROLE_KEY
 * Run: npx tsx --env-file=.env scripts/seed-epc-learning-outcomes.ts
 */
...
const SOURCE =
  "Electrostatic Potential and Capacitance  Learning Outcomes.docx";
...
async function main() {
  ...
  const parsedPath = resolve(process.cwd(), "tmp-epc-outcomes-parsed.json");
