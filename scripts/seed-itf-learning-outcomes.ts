/**
 * Seed Learning Outcomes for Inverse Trigonometric Functions into
 * `learning_outcomes_questions` from tmp-itf-outcomes-parsed.json.
 *
 * Source DOCX: Learning Outcomes of Class 12 Maths Inverse Trigonometric Functons.docx
 *
 * Env: NEXT_PUBLIC_SUPABASE_URL, SUPABASE_SERVICE_ROLE_KEY
 * Run: npx tsx --env-file=.env scripts/seed-itf-learning-outcomes.ts
 */
...
const SOURCE =
  "Learning Outcomes of Class 12 Maths Inverse Trigonometric Functons.docx";
...
async function main() {
  ...
  const parsedPath = resolve(process.cwd(), "tmp-itf-outcomes-parsed.json");
