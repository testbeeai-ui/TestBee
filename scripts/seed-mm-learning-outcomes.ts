/**
 * Seed Learning Outcomes for Magnetism and Matter into
 * `learning_outcomes_questions` from tmp-mm-outcomes-parsed.json.
 *
 * Source DOCX: Learning Outcomes Magnetism and Matter.docx
 *
 * Env: NEXT_PUBLIC_SUPABASE_URL, SUPABASE_SERVICE_ROLE_KEY
 * Run: npx tsx --env-file=.env scripts/seed-mm-learning-outcomes.ts
 */
...
const SOURCE = "Learning Outcomes Magnetism and Matter.docx";
...
async function main() {
  ...
  const parsedPath = resolve(process.cwd(), "tmp-mm-outcomes-parsed.json");
