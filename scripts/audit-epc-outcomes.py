"""Audit EPC parsed Learning Outcomes."""
...
text = Path("tmp-epc-lo.txt").read_text(encoding="utf-8")
parsed = json.loads(Path("tmp-epc-outcomes-parsed.json").read_text(encoding="utf-8"))
