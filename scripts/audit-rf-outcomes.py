"""Audit Relations and Functions parsed Learning Outcomes."""
...
text = Path("tmp-rf-lo.txt").read_text(encoding="utf-8")
parsed = json.loads(Path("tmp-rf-outcomes-parsed.json").read_text(encoding="utf-8"))
