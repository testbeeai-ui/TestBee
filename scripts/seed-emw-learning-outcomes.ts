/**
 * Seed Learning Outcomes for Electromagnetic Waves into
 * `learning_outcomes_questions` from tmp-emw-outcomes-parsed.json.
 *
 * Source DOCX: Learning Outcomes Class 12 Physics Electromagnetic Waves.docx
 *
 * Env: NEXT_PUBLIC_SUPABASE_URL, SUPABASE_SERVICE_ROLE_KEY
 * Run: npx tsx --env-file=.env scripts/seed-emw-learning-outcomes.ts
 */
...
const SOURCE = "Learning Outcomes Class 12 Physics Electromagnetic Waves.docx";
...
async function main() {
  ...
  const parsedPath = resolve(process.cwd(), "tmp-emw-outcomes-parsed.json");
