...
- 2026-05-24: Fixed v2 `useUserStore` auth binding so migrated unlinked local profiles are adopted without clearing saved state; added `lib/userStoreAuthBinding.test.ts`.
