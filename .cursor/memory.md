...
- 2026-05-29: Fixed auth local-state binding data loss, stale saved-content sync guard, Learning Buddy privacy masking gaps, and anchored gauntlet streak build issue.
