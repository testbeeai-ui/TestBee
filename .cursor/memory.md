...
## Decisions Log
- 2026-06-08: Critical self-grant hardening — admin checks default to `user_roles`; production blocks simulated payment/plan-reset routes; coupon redemption is atomic; `profiles_block_self_entitlement_updates` prevents browser self-updates to admin/subscription entitlement columns.
