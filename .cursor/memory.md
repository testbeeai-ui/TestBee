...
## Decisions Log
- 2026-06-13: **Critical bug fixes** — waitlist Step 2 email-bound updates + refcode preservation; MCQ cached route uses authenticated/server client; soft site-presence offline no longer clears learning/Gyan presence.
