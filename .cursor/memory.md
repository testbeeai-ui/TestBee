...
## Decisions Log
- 2026-05-30: Security fix — protected `profiles` subscription/reward state with DB trigger guard; disabled self-service paid/trial plan switching; trial activation no longer resets reward claim state.
