...
## Decisions Log
- 2026-06-10: Critical waitlist/whitelist hardening — Step 2 ambassador updates require matching waitlist ID + email; email-only overwrites rejected; API auth enforces approved-email gate; completed existing users backfilled into `approved_emails`.
