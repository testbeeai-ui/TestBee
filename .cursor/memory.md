...
## Decisions Log
- 2026-06-05: Hardened `accept_buddy_invite(text, uuid, int, int)` via forward migration: service-role-only grants plus invite/profile row locks to prevent forged direct RPC accepts and concurrent cap/token races.
