...
## Decisions Log
- 2026-06-11: Blocked production RDM coupon purchase minting unless explicit non-production simulation flag is enabled (`lib/subscription/rdmPurchaseGuard.ts`, `/api/user/coupons/purchase`) to prevent unverified paid-credit creation.
