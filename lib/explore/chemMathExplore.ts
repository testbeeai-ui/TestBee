...
export const CLASS12_MATH_CHAPTER_BLURB: Record<string, string> = {
  ...
  Matrices: "Matrix operations, transpose, inverse, and applications in linear equation systems.",
  Determinants:
  ...
  Vectors: "Vector algebra, scalar and vector products, and geometric interpretation in space.",
