...
export const CLASS11_PHYSICS_CHAPTER_BLURB: Record<string, string> = {
  ...
  "Motion in a Plane": "Vector addition, projectile motion, and circular motion in two dimensions.",
  "Laws of Motion": "Newton's three laws, inertia, momentum, impulse, and applications of force.",
  "Work, Energy and Power":
    "Work-energy theorem, kinetic and potential energy, conservation of energy, and power.",
  Gravitation: "Newton's law of gravitation, g, orbital motion, and satellites in Earth's field.",
  "System of Particles and Rotational Motion":
    "Center of mass, rotational dynamics, torque, and equilibrium of rigid bodies.",
  "Kinetic Theory": "Kinetic theory of gases, molecular speeds, and thermal behavior of matter.",
  "Mechanical Properties of Solids":
  ...
  Thermodynamics: "Zeroth to first laws, heat, internal energy, and thermodynamic processes.",
  Oscillations: "Simple harmonic motion, periodic time, energy in SHM, and damped oscillations.",
  Waves: "Wave motion in springs and strings, wave speed, and standing wave patterns.",
};
