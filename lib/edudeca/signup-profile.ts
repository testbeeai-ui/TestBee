...
export const EDUDECA_REGISTRATION_SUCCESS_WAIT_BEFORE = "While waiting, please ";

export const EDUDECA_EDUBITE_PRACTICE_LINK_LABEL = "download the Edubite app";

export const EDUDECA_REGISTRATION_SUCCESS_WAIT_AFTER = " for practice for now.";

export const EDUDECA_REGISTRATION_SUCCESS_FUTURE_MESSAGE =
  "In the future we will share a Play Store QR.";

export const EDUDECA_REGISTRATION_SUCCESS_WAIT_MESSAGE = `${EDUDECA_REGISTRATION_SUCCESS_WAIT_BEFORE}${EDUDECA_EDUBITE_PRACTICE_LINK_LABEL}${EDUDECA_REGISTRATION_SUCCESS_WAIT_AFTER} ${EDUDECA_REGISTRATION_SUCCESS_FUTURE_MESSAGE}`;
