...
export const breakActivities: BreakActivity[] = [
  ...
  },
  {
    ...
    content:
      'A man walks into a restaurant and orders a water. The waiter pulls out a gun and points it at him. The man says "Thank you" and walks out. Why?',
  ...
  },
  {
    ...
    content:
      "You have 8 balls. One is heavier. You have a balance scale. What is the minimum number of weighings needed to find the heavy ball?",
