-- Repair: some remote DBs never applied 20260502120000_achievement_marksheets_and_verification.sql
-- (migration history mismatch). Adds achievement columns + trigger + bucket if missing.
