-- Grant admin to alexis36sg@gmail.com (idempotent).
...
BEGIN
  ...
  IF v_user_id IS NULL THEN
    RAISE NOTICE 'No auth.users row for alexis36sg@gmail.com — user must sign up first, then deploy this migration again.';
    RETURN;
  END IF;
