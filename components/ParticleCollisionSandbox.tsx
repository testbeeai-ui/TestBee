  ...
  return (
    <div className="my-8 rounded-xl border-2 border-primary/30 bg-primary/5 p-4 sm:p-6 overflow-hidden">
      ...
      <p className="mb-4 text-sm text-muted-foreground">
        ...
        <strong className="text-foreground">thermal equilibrium</strong> — entropy & second law in
        action.
      </p>
      ...
      <div className="mt-4 flex items-start gap-2 rounded-lg border border-primary/20 bg-primary/5 p-3">
        ...
        <div className="text-sm text-muted-foreground">
          <strong className="text-foreground">What&apos;s happening:</strong> Box A (cyan) has fast
          particles; Box B (orange) has slow ones. When you remove the wall, collisions transfer
          energy until both sides have the same average speed. That&apos;s{" "}
          <strong className="text-foreground">thermal equilibrium</strong> — the second law drives
          the system toward maximum entropy.
        </div>
      </div>
    </div>
  );
