          ...
          {askStep === 4 && (
            <div className="space-y-3 rounded-xl border border-border bg-muted/30 p-4">
              <p className="text-sm font-medium text-foreground">
                Base cost: {costRdm} RDM{" "}
                <span className="text-muted-foreground font-normal">(0 during beta)</span>
              </p>
              <p className="text-xs text-muted-foreground">
                Your balance:{" "}
                <span className="font-semibold text-edu-orange">{profile?.rdm ?? 0} RDM</span>
              </p>
              <p className="text-sm font-medium text-foreground mt-2">Optional bounty</p>
              <p className="text-xs text-muted-foreground">
                Adding a bounty increases visibility and incentivizes quick, quality answers.
              </p>
              ...
              <div className="flex items-center gap-2 mt-2">
                ...
                <Input
                  ...
                  value={
                    customBountyInput !== ""
                      ? customBountyInput
                      : [0, 10, 50, 100].includes(bountyRdm)
                        ? ""
                        : String(bountyRdm)
                  }
                  onChange={(e) => {
              ...
              <p className="text-sm font-semibold text-foreground pt-2 border-t border-border mt-2">
                Total: {costRdm + bountyRdm} RDM{" "}
                {profile != null && costRdm + bountyRdm > (profile.rdm ?? 0) && (
          ...
          {askStep === 1 && (
            <>
              ...
              <Button
                ...
                disabled={!title.trim() || !subject || duplicateChecking}
              >
          ...
          {askStep === 4 && (
            <>
              ...
              <Button
                ...
                disabled={
                  submitLoading || (profile != null && costRdm + bountyRdm > (profile.rdm ?? 0))
                }
              >
