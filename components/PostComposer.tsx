    ...
    >
      ...
      <div className="space-y-4">
        ...
        {(config.showTags || config.showDueDate) && (
          <div
            className={`grid gap-3 ${config.showTags && config.showDueDate ? "grid-cols-2" : "grid-cols-1"}`}
          >
            {config.showTags && (
              <div>
                <label className="text-xs font-extrabold text-foreground block mb-1.5">
        ...
        <div className="bg-muted/30 rounded-xl p-4 space-y-2.5">
          ...
          <label className="flex items-center gap-2 cursor-pointer">
            ...
            <span className="text-sm font-medium text-muted-foreground">
              Also publish to Google Classroom
            </span>
            {publishToGoogle && (
              <span className="text-xs font-bold text-primary">Will post as Material</span>
            )}
            {!publishToGoogle && (
        ...
        <Button
          ...
          className="w-full rounded-xl edu-btn-primary h-12 font-extrabold gap-2"
        >
