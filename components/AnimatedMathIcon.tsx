        ...
        */}
        ...
        >
          ...
          <g className="hud-container" mask="url(#hudFadeMath)">
            ...
            <path
              className="sine-wave"
              filter="url(#hudGlowMath)"
              d="M -75 150 Q -37.5 70 0 150 T 75 150 T 150 150 T 225 150 T 300 150 T 375 150"
            />
            ...
            <g className="geo-core" filter="url(#hudGlowMath)">
              ...
              <polygon
                className="poly-2"
                points="150,195 195,115 105,115"
                fill="none"
                stroke="#F59E0B"
                strokeWidth="3"
              />
            ...
            <g filter="url(#hudGlowMath)">
              <text className="equation eq-1" x="50" y="90" fill="#7E22CE">
                ∫ f(x)dx
              </text>
              <text className="equation eq-2" x="190" y="70" fill="#0EA5E9">
                ∑ n=1
              </text>
              <text className="equation eq-3" x="40" y="210" fill="#E11D48">
                Δy/Δx
              </text>
              <text className="equation eq-4" x="175" y="235" fill="#9333EA">
                e^(iπ)+1=0
              </text>
            </g>
          </g>
          ...
          <g className="idle-cube" filter="url(#cubeShadowMath)">
            <path
              className="face face-inner"
              d="M 135 125 L 165 125 L 150 145 L 165 165 L 135 165"
              fill="none"
              stroke="#60A5FA"
              strokeWidth="4"
              strokeLinecap="round"
            ...
            <path
              ...
              d="M 150 210 L 80 170 L 80 90 L 150 130 Z"
              fill="url(#glassLeft)"
              stroke="#E0F2FE"
              strokeWidth="2"
              strokeLinejoin="round"
            ...
            <path
              ...
              d="M 150 210 L 220 170 L 220 90 L 150 130 Z"
              fill="url(#glassRight)"
              stroke="#BFDBFE"
              strokeWidth="2"
              strokeLinejoin="round"
            ...
            <path
              ...
              d="M 150 50 L 220 90 L 150 130 L 80 90 Z"
              fill="url(#glassTop)"
              stroke="#FFFFFF"
              strokeWidth="3"
              strokeLinejoin="round"
