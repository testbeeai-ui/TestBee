...
const postTemplates: PostTemplate[] = [
  ...
  },
  {
    ...
    body: (_topic, subs) =>
      `Covered all ${subs.length} subtopics. The key formulas are worth bookmarking.`,
    type: "achievement",
  },
  {
    action: (_topic, subject) => `Exploring ${subject}`,
    body: (topic, subs) =>
      `Started ${topic} today. ${subs[0] || "First chapter"} looks interesting!`,
    type: "share",
  },
  {
    action: (_topic, _subject) => `Study tip`,
    body: (topic, _subs) =>
      `Pro tip: practice ${topic} problems daily, not just before exams. Consistency beats cramming.`,
    type: "share",
  },
];
