...
const SELECT_LESSONS_RAW_LEGACY =
  `id, user_id, kind, title, content, tags, subject, chapter_ref, boost_count, created_at, ${PROFILE_EMBED}`;
const SELECT_LESSONS_RAW_FULL =
  `id, user_id, kind, title, content, tags, subject, chapter_ref, boost_count, upvote_count, downvote_count, comment_count, created_at, ${PROFILE_EMBED}`;
            ...
            <RawFeedPostCard
              ...
              onSaveForRevision={() =>
                toast({
                  ...
                  description: "Linking raw posts to your revision shelf is coming next.",
                })
              }
            />
          ))}
