...
/**
 * Student settings + EduFund teaser + Contact, in the two-column layout
 * (tall Settings card left; EduFund + Contact stacked right).
 */
export default function StudentSettingsHub() {
  ...
  return (
    <div className="grid grid-cols-1 items-start gap-3 lg:grid-cols-2 lg:gap-4 2xl:gap-5">
      <div className="rounded-2xl border border-border bg-card p-4 dark:border-white/10 dark:bg-[#0d1118] 2xl:rounded-[1.125rem] 2xl:p-6">
        ...
        <div className="space-y-3 2xl:space-y-4">
          ...
          <div className="border-t border-border pt-3 dark:border-white/10 2xl:pt-4">
            <p className="text-[10px] font-semibold uppercase tracking-wide text-muted-foreground dark:text-slate-500 2xl:text-xs">
              Account
            </p>
