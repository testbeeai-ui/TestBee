    ...
    >
      <div className="p-8 pb-0 text-center">
        ...
        <p className="text-muted-foreground max-w-md mx-auto mb-8 font-medium">
          Credits let you create and edit with AI. Each user in your workspace gets their own
          credits.
        </p>
      </div>
      ...
      <div className="bg-background pt-2 px-6 pb-6 rounded-t-3xl border-t border-border shadow-[0_-8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_-8px_30px_rgb(0,0,0,0.2)]">
        <Tabs defaultValue="get-more" className="w-full">
          ...
          <TabsContent value="get-more" className="mt-0 outline-none">
            ...
            >
              <div>
                <h4 className="font-extrabold text-lg text-foreground mb-1">
                  More power, fewer limits
                </h4>
                <p className="text-muted-foreground font-medium text-sm">
                  Upgrade for more credits, advanced AI models, and branding tools.
                </p>
              </div>
            ...
            <Accordion
              type="single"
              collapsible
              className="w-full mb-6 max-w-2xl mx-auto space-y-2"
            >
              <AccordionItem value="item-1" className="border-border px-1">
                ...
                <AccordionContent className="text-muted-foreground leading-relaxed font-medium pb-4">
                  Generating texts, editing images with AI tools, running complex background removal
                  operations, and answering advanced mock tests consume credits.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-2" className="border-border px-1">
                ...
                <AccordionContent className="text-muted-foreground leading-relaxed font-medium pb-4">
                  Free users receive 50 RDM Balance daily on login. You can increase this limit by
                  referring friends or upgrading your account.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-3" className="border-border px-1">
                ...
                <AccordionContent className="text-muted-foreground leading-relaxed font-medium pb-4">
                  Besides upgrading to a paid tier, participating in daily challenges, saving
                  helpful study materials, and successfully referring classmates directly yield
                  bonus credits.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          ...
          <TabsContent value="refer" className="mt-0 outline-none">
            ...
            >
              ...
              <h4 className="font-extrabold text-xl text-foreground mb-2">
                Invite friends, get credits
              </h4>
              <p className="text-muted-foreground max-w-sm mx-auto mb-6">
                Give your friends 100 free credits and receive 50 bonus credits when they solve
                their first mock test.
              </p>
          ...
          <TabsContent value="invite" className="mt-0 outline-none">
            ...
            >
              ...
              <h4 className="font-extrabold text-xl text-foreground mb-2">
                Build your study group
              </h4>
              <p className="text-muted-foreground max-w-sm mx-auto mb-6">
                Invite classmates to your workspace to share notes, flashcards, and compete in team
                mock exams.
              </p>
