      ...
      setSummary({
        ...
        avg_video_rating:
          videoReviews.length > 0
            ? Math.round(
                (videoReviews.reduce((s, r) => s + (r.video_rating ?? 0), 0) /
                  videoReviews.length) *
                  10
              ) / 10
            : null,
        avg_voice_rating:
          voiceReviews.length > 0
            ? Math.round(
                (voiceReviews.reduce((s, r) => s + (r.voice_rating ?? 0), 0) /
                  voiceReviews.length) *
                  10
              ) / 10
            : null,
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-6 relative z-10">
            <div className="text-center">
              <p className="text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-br from-amber-500 to-orange-400">
                {summary.avg_rating}
              </p>
      ...
      {!isOwner && myReview && !editing && !showSuccess && (
        ...
        >
          <div className="flex items-start justify-between">
            <div>
              <p className="text-xs font-extrabold text-amber-600 dark:text-amber-400 uppercase tracking-wider mb-2">
                Your Review
              </p>
          ...
          >
            {reviews.map((r) => (
              <motion.div
                ...
                className="edu-card p-5 hover:shadow-md transition-shadow"
              >
                  ...
                  <UserHoverCard userId={r.user_id}>
                    <div className="flex items-center gap-2 cursor-pointer hover:opacity-80 transition-opacity shrink-0">
                      ...
                      <div className="flex items-center gap-2 flex-wrap">
                        <span className="font-extrabold text-foreground hover:text-primary hover:underline">
