...
export const INVESTOR_NAV_LINKS = [
  ...
  { label: "Edufundz", href: "/#investor-edufund" },
  { label: "Pricing", href: "/pricing" },
...
export const PROBLEM_EDUBLAST = [
  ...
  "Every action \u2014 answering, tagging, upvoting, attending class \u2014 earns RDM tokens that build toward real financial aid (Edufundz).",
...
export const PARENT_STORIES = [
  ...
  {
    title: "Edufundz means learning can earn real financial aid",
    text: "Every time your child studies on EduBlast \u2014 attends a class, answers a doubt, completes a mock \u2014 they earn RDM. Accumulate enough and they become eligible for Edufundz grants of up to \u20b950,000. Consistent, genuine learning is literally rewarded. This is not a gimmick \u2014 it is accountability with a return.",
...
export const FEATURE_TABLE_ROWS = [
  ...
  },
  {
    ...
    ours: "RDM rewards \u00b7 Edufundz grants \u00b7 live leaderboards",
...
export const PRICING_PLANS = [
  ...
  },
  {
    ...
    features: [
      ...
      "Edufundz Scholar tier eligibility",
    ],
    cta: "Start Scholar",
  ...
  },
  {
    ...
    features: [
      ...
      "Personal Edufundz advisor",
      "Champion tier Edufundz eligibility",
