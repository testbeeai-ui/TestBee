...
const items = [
  ...
  {
    id: "understand",
    label: 'I understand: Classroom is the "official record"; ESM adds social learning + fun',
  },
];
    ...
    >
      <div className="text-center mb-6">
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Quick checklist to ensure a smooth setup
        </p>
      </div>
      ...
      <div className="flex gap-3">
        ...
        <Button
          onClick={onContinue}
          disabled={!allChecked}
          className="rounded-xl edu-btn-primary flex-1 gap-1"
        >
