...
export default function DashboardLayout({ children, streakTimer, hideSidebar = false }: DashboardLayoutProps) {
  const pathname = usePathname();
  return (
    <AppLayout streakTimer={streakTimer} wideMain>
      {hideSidebar ? (
        /* Full-width layout — no sidebar, no mobile nav */
